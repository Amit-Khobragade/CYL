...
const query = {
  user: {
    ...
    resolve: (parent: any, args: any) => data.getUserById(args._id),
  },
  checkJwt: {
    type: GraphQLBoolean,
    args: {
    ...
    resolve: (parent: any, args: any): Boolean =>
      data.checkJwt(args._id, args.jwt),
  },
  ...
  users: {
    ...
    resolve: (parent: any, args: any) => data.getAllUsers(args.password),
  },
};
...
const mutation = {
  userLogin: {
    ...
    resolve: (parent: any, args: any) => data.login(args.email, args.password),
  },
  createUser: {
    type: UserType,
    args: {
    ...
    resolve: (parent: any, args: any) => data.addUser(args),
  },
  makeStore: {
    type: UserType,
    args: {
    ...
    resolve: (parent: any, args: any) => data.makeUserStore(args._id, args.jwt),
  },
  trustStore: {
    type: UserType,
    args: {
    ...
    resolve: (parent: any, args: any) => data.trustUser(args._id, args.jwt),
  },
};
